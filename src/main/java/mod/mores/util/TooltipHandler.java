...
//            tooltip.add(Mores.getBlockingTextComponent());
//            if (shield == Items.SHIELD) {
//                tooltip.add(Mores.getDamageReductionTextComponent(Config.defaultDamageReduction.get()));
//            } else if (shield instanceof ItemShield) {
//                tooltip.add(Mores
//                        .getDamageReductionTextComponent(((ItemShield) shield).getDamageReduction()));
//            } else {
//                tooltip.add(Mores.getDamageReductionTextComponent(
