...
public class AlloyFurnaceRecipes
{
    ...
    private AlloyFurnaceRecipes()
    {
        ...
        addAlloyRecipe(new ItemStack(ItemInit.TIN_INGOT), new ItemStack(ItemInit.COPPER_INGOT), new ItemStack(ItemInit.BRONZE_INGOT), 4.0F);
        addAlloyRecipe(new ItemStack(ItemInit.TURQUOISE_GEM), new ItemStack(Items.QUARTZ), new ItemStack(ItemInit.TURQUARTZ_GEM), 6.0F);
    }
