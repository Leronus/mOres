...
public class TileEntityAlloySmelter extends TileEntity implements ITickable, IInventory {
    ...
    public ItemStackHandler itemStackHandlerInventory = new ItemStackHandler(NonNullList.withSize(4, ItemStack.EMPTY)){
        ...
        protected void onContentsChanged(int slot) {
            if (!world.isRemote) {
                ...
                //Mores.network.sendToAllAround(new PacketUpdatedAlloyFurnace(TileEntityAlloySmelter.this), new NetworkRegistry.TargetPoint(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), 64));
            }
        }
    };
    @Override
    ...
    public void handleUpdateTag(NBTTagCompound tag) {
        ...
        BlockAlloySmelter.setState(isBurning(), getWorld(), getPos());
    }
    @Override
