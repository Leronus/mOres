...
public class RubyOreBase extends Block
{
    public RubyOreBase(String name, Material material, float hardness, float resistance, int miningLevel, String tool)
    {
        super(material);
    ...
    public int getExpDrop(IBlockState state, IBlockAccess world, BlockPos pos, int fortune) {
        ...
        return MathHelper.getInt(rand, 3, 8);
    }
}
