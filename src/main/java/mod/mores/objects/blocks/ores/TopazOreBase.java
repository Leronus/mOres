...
public class TopazOreBase extends Block
{
    public TopazOreBase(String name, Material material, float hardness, float resistance, int miningLevel, String tool)
    {
        super(material);
