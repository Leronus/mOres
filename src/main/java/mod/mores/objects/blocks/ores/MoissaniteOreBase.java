...
public class MoissaniteOreBase extends Block
{
    public MoissaniteOreBase(String name, Material material, float hardness, float resistance, int miningLevel, String tool)
    {
        super(material);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ItemInit.MOISSANITE_GEM;
    }
