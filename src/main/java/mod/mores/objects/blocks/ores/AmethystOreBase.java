...
public class AmethystOreBase extends Block
{
    public AmethystOreBase(String name, Material material, float hardness, float resistance, int miningLevel, String tool)
    {
        super(material);
