...
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.DARK_GRAY + "Jump Boost"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_TIN.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_COBALT){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.GOLD + "Haste"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_COBALT.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_AMETHYST){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.GRAY + "Slow Falling"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_AMETHYST.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_OBSIDIAN){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.DARK_PURPLE + "Strength & Slowness"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_OBSIDIAN.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_EMERALD){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.GREEN + "Luck"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_EMERALD.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_TOURMALINE){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.RED + "Regeneration"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_TOURMALINE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_TANZANITE){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.YELLOW + "Speed"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_TANZANITE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_RUBY){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.DARK_RED + "Fire Resistance"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_RUBY.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_SAPPHIRE){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.BLUE + "Night Vision"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_SAPPHIRE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_TURQUOISE){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.AQUA + "Water Breathing & Dolphins"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_TURQUOISE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_COPPER){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_COPPER.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_BRONZE){
//            //Making the tooltips
//            tooltip.add(("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_BRONZE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_SILVER){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_SILVER.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_STERLING){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_STERLING.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_STEEL){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_STEEL.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_TOPAZ){
//            //Making the tooltips
//            tooltip.add("Full Set Bonus: " + ChatFormatting.GOLD + "Haste"));
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_TOPAZ.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_MOISSANITE){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_MOISSANITE.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_ONYX){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_ONYX.getDurabilityForSlot(equipmentSlotType)));
//        }
//        else if (armorMaterial == ArmorMaterial.ARMOR_GRAPHENE){
//            //Making the tooltips
//            tooltip.add("Max Uses: " + ChatFormatting.LIGHT_PURPLE + ArmorMaterial.ARMOR_GRAPHENE.getDurabilityForSlot(equipmentSlotType)));
//        }
//    }
