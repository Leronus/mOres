...
public enum ToolMaterial implements IItemTier {
    ...
    TOOL_SILVER(2, 230, 5.5F, 2.0F, 24, () -> Ingredient.of(ItemInit.SILVER_INGOT.get())),
    ...
    TOOL_TOURMALINE(4, 1500, 7.5F, 3.0F, 22, () -> Ingredient.of(ItemInit.TOURMALINE_GEM.get())),
    TOOL_TANZANITE(5, 2000, 8.0F, 3.0F, 24, () -> Ingredient.of(ItemInit.TANZANITE_GEM.get())),
    TOOL_RUBY(5, 1600, 10.0F, 3.0F, 16, () -> Ingredient.of(ItemInit.RUBY_GEM.get())),
    TOOL_SAPPHIRE(5, 1750, 8.0F, 3.5F, 10, () -> Ingredient.of(ItemInit.SAPPHIRE_GEM.get())),
    ...
    TOOL_TURQUOISE(6, 2700, 10.0F, 3.5F, 22, () -> Ingredient.of(ItemInit.TURQUOISE_GEM.get())),
