...
public class PlayerEvents {
    ...
    public static void onPlayerToss(ItemTossEvent itemTossEvent){
        ...
        if (state.getBlock() == BlockInit.TURQUOISE_BLOCK.get()){
            ...
            //Server
            world.playSound(null, player.blockPosition(), SoundTypeInit.DARUDE_SANDSTORM.get(), SoundCategory.MUSIC,0.1F, 1.0F);
        }
            ...
            //Server
            world.playSound(null, player.blockPosition(), SoundTypeInit.RICK_ASTLEY.get(), SoundCategory.MUSIC,0.1F, 1.0F);
        }
            ...
            //Server
            world.playSound(null, player.blockPosition(), SoundTypeInit.CRAZY_FROG.get(), SoundCategory.MUSIC, 0.1F, 1.0F);
        }
    }
}
