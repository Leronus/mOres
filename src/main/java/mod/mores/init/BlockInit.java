...
public class BlockInit {
    ...
    public static final RegistryObject<Block> TIN_ORE = BLOCKS.register("tin_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_LIGHT_GRAY).harvestTool(ToolType.PICKAXE).harvestLevel(0).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> COPPER_ORE = BLOCKS.register("copper_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.PICKAXE).harvestLevel(0).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> SILVER_ORE = BLOCKS.register("silver_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_WHITE).harvestTool(ToolType.PICKAXE).harvestLevel(1).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_SILVER_ORE = BLOCKS.register("deepslate_silver_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_WHITE).harvestTool(ToolType.PICKAXE).harvestLevel(1).strength(4.5F, 3.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> NETHER_SILVER_ORE = BLOCKS.register("nether_silver_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_WHITE).harvestTool(ToolType.PICKAXE).harvestLevel(1).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> COBALT_ORE = BLOCKS.register("cobalt_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_COBALT_ORE = BLOCKS.register("deepslate_cobalt_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> TOPAZ_ORE = BLOCKS.register("topaz_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TOPAZ_ORE = BLOCKS.register("deepslate_topaz_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> TOURMALINE_ORE = BLOCKS.register("tourmaline_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PINK).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TOURMALINE_ORE = BLOCKS.register("deepslate_tourmaline_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PINK).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> OBSIDIAN = VANILLA_BLOCKS.register("obsidian", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).harvestLevel(3).harvestTool(ToolType.PICKAXE)));

    public static final RegistryObject<Block> TANZANITE_ORE = BLOCKS.register("tanzanite_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.NETHER_ORE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> SAPPHIRE_ORE = BLOCKS.register("sapphire_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = BLOCKS.register("deepslate_sapphire_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> NETHER_SAPPHIRE_ORE = BLOCKS.register("nether_sapphire_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> TURQUOISE_ORE = BLOCKS.register("turquoise_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TURQUOISE_ORE = BLOCKS.register("deepslate_turquoise_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> DIAMOND_ORE = VANILLA_BLOCKS.register("diamond_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.DIAMOND).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> DIAMOND_BLOCK = VANILLA_BLOCKS.register("diamond_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.DIAMOND).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> RUBY_ORE = BLOCKS.register("ruby_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = BLOCKS.register("deepslate_ruby_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> NETHER_RUBY_ORE = BLOCKS.register("nether_ruby_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> MOISSANITE_ORE = BLOCKS.register("moissanite_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> MOISSANITE_NETHER_ORE = BLOCKS.register("moissanite_nether_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(3.0F, 3.0F).sound(SoundType.NETHER_GOLD_ORE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> DEEPSLATE_MOISSANITE_ORE = BLOCKS.register("deepslate_moissanite_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> ANCIENT_DEBRIS = VANILLA_BLOCKS.register("ancient_debris", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_BLACK).requiresCorrectToolForDrops().harvestLevel(5).strength(30.0F, 1200.0F).sound(SoundType.ANCIENT_DEBRIS)));
    public static final RegistryObject<Block> NETHERITE_BLOCK = VANILLA_BLOCKS.register("netherite_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_BLACK).requiresCorrectToolForDrops().harvestLevel(5).strength(30.0F, 1200.0F).sound(SoundType.ANCIENT_DEBRIS)));

    public static final RegistryObject<Block> ONYX_ORE = BLOCKS.register("onyx_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_BLACK).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
