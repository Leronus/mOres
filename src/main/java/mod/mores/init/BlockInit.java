...
public class BlockInit {
    ...
    public static final RegistryObject<Block> DEEPSLATE_TOPAZ_ORE = BLOCKS.register("deepslate_topaz_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TOURMALINE_ORE = BLOCKS.register("deepslate_tourmaline_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_PINK).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = BLOCKS.register("deepslate_sapphire_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = BLOCKS.register("deepslate_ruby_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_MOISSANITE_ORE = BLOCKS.register("deepslate_moissanite_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.METAL)));
