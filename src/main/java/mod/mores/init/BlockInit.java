...
public class BlockInit {
    ...
    public static final RegistryObject<Block> TOPAZ_ORE = BLOCKS.register("topaz_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(3.0F, 3.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> TOPAZ_BLOCK = BLOCKS.register("topaz_block", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> DEEPSLATE_TOPAZ_ORE = BLOCKS.register("deepslate_topaz_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TOURMALINE_ORE = BLOCKS.register("deepslate_tourmaline_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_PINK).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> TURQUOISE_ORE = BLOCKS.register("turquoise_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(3.0F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_TURQUOISE_ORE = BLOCKS.register("deepslate_turquoise_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = BLOCKS.register("deepslate_ruby_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(4.5F, 3.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> DEEPSLATE_MOISSANITE_ORE = BLOCKS.register("deepslate_moissanite_ore", () -> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(4.5F, 3.0F).sound(SoundType.METAL)));
