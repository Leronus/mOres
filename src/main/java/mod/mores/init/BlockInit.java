...
public class BlockInit {
    ...
    public static final RegistryObject<Block> AMETHYST_DEEPSLATE_ORE = BLOCKS.register("amethyst_deepslate_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(4.5F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> AMETHYST_BLOCK = BLOCKS.register("amethyst_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> TOPAZ_ORE = BLOCKS.register("topaz_ore", () -> new BlockOre(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(3.0F, 3.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> TOPAZ_BLOCK = BLOCKS.register("topaz_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_LIGHT_BLUE).harvestTool(ToolType.PICKAXE).harvestLevel(2).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> TOURMALINE_BLOCK = BLOCKS.register("tourmaline_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_PINK).harvestTool(ToolType.PICKAXE).harvestLevel(3).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> TANZANITE_BLOCK = BLOCKS.register("tanzanite_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> SAPPHIRE_BLOCK = BLOCKS.register("sapphire_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.LAPIS).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> TURQUOISE_BLOCK = BLOCKS.register("turquoise_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_PURPLE).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> RUBY_BLOCK = BLOCKS.register("ruby_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_RED).harvestTool(ToolType.PICKAXE).harvestLevel(4).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> MOISSANITE_BLOCK = BLOCKS.register("moissanite_block", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_LIGHT_GREEN).harvestTool(ToolType.PICKAXE).harvestLevel(5).strength(5.0F, 6.0F).sound(SoundType.METAL).requiresCorrectToolForDrops()));
