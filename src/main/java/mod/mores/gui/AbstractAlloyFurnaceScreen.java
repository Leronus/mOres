...
//
//public abstract class AbstractAlloyFurnaceScreen<T extends AbstractAlloyFurnaceContainer>  extends AbstractAlloyFurnaceContainer<T>
//{
//
...
//
//        final AbstractAlloyFurnaceBlockEntity tileEntity = this.menu.tileEntity;
//
...
////        }
//        //Inventory text
//        this.font.draw(matStack, this.title,
