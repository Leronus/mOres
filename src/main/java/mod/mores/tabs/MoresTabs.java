...
public class MoresTabs extends CreativeModeTab {
    ...
    public static final CreativeModeTab MORES_ARMOR = (new MoresTabs(17, "mores_armor") {
        @OnlyIn(Dist.CLIENT)
        public ItemStack makeIcon() {
    ...
    public static final CreativeModeTab MORES_HORSE_ARMOR = (new MoresTabs(18, "mores_horse_armor") {
        @OnlyIn(Dist.CLIENT)
        public ItemStack makeIcon() {
    ...
    public static final CreativeModeTab MORES_FOODS = (new MoresTabs(19, "mores_foods") {
        @OnlyIn(Dist.CLIENT)
        public ItemStack makeIcon() {
    ...
    public static final CreativeModeTab MORES_ENTITIES = (new MoresTabs(20, "mores_entities") {
        @OnlyIn(Dist.CLIENT)
        public ItemStack makeIcon() {
