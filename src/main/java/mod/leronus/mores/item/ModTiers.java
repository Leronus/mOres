...
public class ModTiers {
    ...
    public static final ForgeTier BRONZE = new ForgeTier(2, 270, 5.5F, 2.0F, 7, BlockTags.NEEDS_STONE_TOOL,() -> Ingredient.of(ModItems.BRONZE_INGOT.get()));
    ...
    public static final ForgeTier EMERALD = new ForgeTier(3, 900, 7.5F, 3.0F, 17,  BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(Items.EMERALD));
    ...
    public static final ForgeTier RUBY = new ForgeTier(3, 1600, 8.0F, 3.5F, 16,  BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.RUBY_GEM.get()));
    public static final ForgeTier SAPPHIRE = new ForgeTier(3, 1750, 9.0F, 4.0F, 12, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.SAPPHIRE_GEM.get()));
    public static final ForgeTier MOISSANITE = new ForgeTier(4, 1400, 9.0F, 4.0F, 10, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.MOISSANITE_GEM.get()));
    ...
    public static final ForgeTier ONYX = new ForgeTier(4, 3000, 9.5F, 5.0F, 15, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.ONYX_GEM.get()));
    public static final ForgeTier TURQUOISE = new ForgeTier(4, 2700, 9.0F, 4.0F, 14, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.TURQUOISE_GEM.get()));
    public static final ForgeTier GRAPHENE = new ForgeTier(5, 5000, 12.0F, 6.0F, 16, ModTags.Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ModItems.GRAPHENE_GEM.get()));
}
