...
//                    }
            ...
            if (e.getItemStack().getItem() instanceof HorseArmorItem horseArmorItem) {
                ...
                tooltip.add(Component.literal(""));
                tooltip.add(Component.translatable("mores.protection").withStyle(ChatFormatting.GRAY).append(Component.translatable(String.valueOf(horseArmorItem.getProtection())).withStyle(ChatFormatting.LIGHT_PURPLE)));
            }
        }
    }
}