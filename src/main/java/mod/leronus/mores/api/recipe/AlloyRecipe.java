...
//
//    public AlloyRecipe(ItemStack output,  int cook_time, float experience,
...
//
//        List<RecipeHolder<AlloyRecipe>> recipes;
//
...
//        }
//
//        for (RecipeHolder<AlloyRecipe> recipe: recipes)
//        {
//            NonNullList<Ingredient> ingrs = recipe.value().getIngredients();
...
//                }
//            } // end-for
//            for (ItemStack stack : (recipe).value().getCatalyst().getItems())
//            {
...
//
//        @Override
//        public @Nullable AlloyRecipe fromNetwork(FriendlyByteBuf buf) {
...
//
//            return new AlloyRecipe(output, cook_time, exp, catalyst, inputs);
//        }
//
//        @Override
